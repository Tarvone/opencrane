...
| **UI Handoff** | [`docs/agents/ui-handoff.md`](docs/agents/ui-handoff.md) | working on the Settings & Session UI redesign handoff — Paper theme tokens, specific mock constraints, and layout requirements (overrides `angular.md` for this phase). |
