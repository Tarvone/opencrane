...
vi.mock("@opencrane/backend/model-routing", async function _mockModelRouting(importOriginal)
{
  const actual = await importOriginal<typeof import("@opencrane/backend/model-routing")>();
