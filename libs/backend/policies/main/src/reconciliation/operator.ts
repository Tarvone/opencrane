...
import type { PolicyOperatorConfig } from "./operator.types.js";
...
export class PolicyOperator
{
  ...
  private config: PolicyOperatorConfig;
   ...
   */
  constructor(kc: k8s.KubeConfig, config: PolicyOperatorConfig, log: Logger)
  {
