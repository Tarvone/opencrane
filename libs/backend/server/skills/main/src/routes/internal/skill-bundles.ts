...
import { compile, GrantCompilerAccess, GrantCompilerPayloadType } from "@opencrane/backend/server/grants";
 ...
 * @see apps/_infra/deploy-k8s/templates/feat-skill-registry-deployment.yaml — where the
