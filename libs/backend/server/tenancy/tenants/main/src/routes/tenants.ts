...
import { compile, compileForPrincipals, GrantCompilerAccess, GrantCompilerPayloadType, _DeriveTenantDatasetMembership } from "@opencrane/backend/server/iam/grants";
import { _DetectTenantProjectionDrift, _RepairTenantProjection } from "@opencrane/backend/server/tenancy/projection";
import { _deleteLiteLlmKey } from "@opencrane/backend/server/reporting/spend";
import { OPENCRANE_API_GROUP, OPENCRANE_API_VERSION, TENANT_CRD_PLURAL, _IsK8sNotFound } from "@opencrane/server/_infra/api";
import { _SetTenantSuspended } from "../core/tenant-suspension.js";
import { _log } from "../log.js";
import type { CreateTenantRequest, EffectiveContractResponse, TenantDatasetMembershipRow, TenantDatasetMembershipSubjectRow, TenantDatasetsResponse, TenantResponse, UpdateTenantDatasetsRequest } from "./tenants.types.js";
 ...
 */
function _BuildTenantDatasetMembershipRows(tenant: string, membership: TenantDatasetsResponse): TenantDatasetMembershipRow[]
{
  return [
 ...
 */
function _BuildTenantDatasetMembershipResponse(memberships: TenantDatasetMembershipSubjectRow[]): TenantDatasetsResponse
{
