# @opencrane/observability — structured logging and execution tracing

> [OpenCrane](../../README.md) › observability
...
Tagged `scope:shared`: a dependency-light package other packages may import — it never depends on
