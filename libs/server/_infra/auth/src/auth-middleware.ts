...
/**
 * Minimal `AccessToken` read surface for per-user database token validation. A server
 * composition that enables device-flow tokens supplies the reader; other compositions omit it.
 */
/**
 ...
 *                 server composition issues no database tokens.
 */
