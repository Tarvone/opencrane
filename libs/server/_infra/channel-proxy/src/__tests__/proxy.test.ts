...
import { _HandleUpgrade, _StripGatewayPrefix, FixedWindowRateLimiter, type UpgradeDeps, type WsProxy, type GatewayProxyRuntime, type ResolveOutcome } from "../index.js";
...
describe("_HandleUpgrade (in-operator gateway proxy)", () =>
{
  ...
  it("propagates a opencrane-ui refusal and rate-limits per identity", async () =>
  {
