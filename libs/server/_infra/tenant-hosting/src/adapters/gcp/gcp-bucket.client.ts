...
import type { GcsBucketOperations } from "./gcp-bucket.client.types.js";
 ...
 * image can omit the package entirely (`npm install --omit=optional`) and the
  ...
  private async _getStorage(): Promise<Storage>
  {
    ...
    catch (err)
    {
      ...
      throw new Error(
        ...
        + "Install the optional GCP dependency (npm install, without --omit=optional). "
