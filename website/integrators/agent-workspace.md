...
1. **Company publishes a new L1 version.** An admin edits the company `SOUL.md` via
   `PUT /api/v1/org/workspace-docs/:name` ([company-docs.ts](https://github.com/italanta/opencrane/blob/main/libs/backend/server/company-docs/main/src/routes/company-docs.ts)).
...
2. **Three-way merge is computed.** The reconciler
   ([reconciliation.logic.ts](https://github.com/italanta/opencrane/blob/main/libs/backend/server/company-docs/main/src/core/reconciliation.logic.ts))
...
(`_DeterministicReconciler` in [reconciler.ts](https://github.com/italanta/opencrane/blob/main/libs/backend/server/company-docs/main/src/core/reconciler.ts))
...
([l0-guard.ts](https://github.com/italanta/opencrane/blob/main/libs/backend/server/company-docs/main/src/core/l0-guard.ts))
