...
Source:
[`grant-compiler.ts`](https://github.com/italanta/opencrane/blob/main/libs/backend/server/grants/main/src/core/grant-compiler.ts)
— `compileForPrincipals(principalIds, payloadType, prisma)`.

[`tenant-contract.ts`](https://github.com/italanta/opencrane/blob/main/libs/backend/server/contract/main/src/routes/internal/tenant-contract.ts)
...
Source:
[`routes/shares.ts`](https://github.com/italanta/opencrane/blob/main/libs/backend/server/grants/main/src/routes/shares.ts)
...
Source:
[`core/grants/derive-dataset-membership.ts`](https://github.com/italanta/opencrane/blob/main/libs/backend/server/grants/main/src/core/derive-dataset-membership.ts).
...
Source:
[`routes/resource-shares.ts`](https://github.com/italanta/opencrane/blob/main/libs/backend/server/grants/main/src/routes/resource-shares.ts).
